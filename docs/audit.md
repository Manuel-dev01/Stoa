...
| # | Tag | Check | Status | Evidence |
|---|---|---|---|---|
| K1 | non-pitch | Paymaster contract not deployed on Arc | PASS | `cast code 0x3BA9A96eE3eFf3A69E2B18886AcF52027EFF8966` → `0x` — confirms Arc-native USDC gas, paymaster intentionally N/A |
